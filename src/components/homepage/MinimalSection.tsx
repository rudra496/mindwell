...
export function MinimalSection({
  ...
  return (
    ...
    >
      <div
        className={`relative min-h-[240px] md:min-h-[320px] group bg-gradient-to-br ${bgGradient} transition-all duration-300 ${!stockPhotoUrl ? "border-b border-white/50 dark:border-slate-700 shadow-inner bg-[length:200%_200%] bg-[position:0%_50%] hover:bg-[position:100%_50%] motion-reduce:hover:bg-[position:0%_50%]" : ""}`}
      >
        {stockPhotoUrl && (
