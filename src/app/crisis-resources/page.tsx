...
export const metadata: Metadata = {
  title: 'Crisis Resources by Country',
  description: 'Country-wise crisis support resources and contacts',
};
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl" id="main-content">
      <section aria-labelledby="crisis-resources-title">
        <h1 id="crisis-resources-title" className="text-4xl font-bold text-gray-900 dark:text-white mb-8">
