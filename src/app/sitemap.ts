...
const STATIC_ROUTES: Array<{ path: string; priority: number; changeFrequency: MetadataRoute.Sitemap[number]["changeFrequency"] }> = [
  ...
  { path: "/disorders/cluster/anxiety", priority: 0.8, changeFrequency: "weekly" },
  { path: "/disorders/cluster/mood", priority: 0.8, changeFrequency: "weekly" },
  { path: "/disorders/cluster/trauma", priority: 0.8, changeFrequency: "weekly" },
  { path: "/disorders/cluster/substance", priority: 0.8, changeFrequency: "weekly" },
  { path: "/disorders/cluster/eating", priority: 0.8, changeFrequency: "weekly" },
  { path: "/disorders/cluster/personality", priority: 0.8, changeFrequency: "weekly" },
  { path: "/disorders/cluster/psychotic", priority: 0.8, changeFrequency: "weekly" },
  { path: "/disorders/cluster/neuro", priority: 0.8, changeFrequency: "weekly" },
  { path: "/disorders/cluster/sleep-other", priority: 0.8, changeFrequency: "weekly" },
